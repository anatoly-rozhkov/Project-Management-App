...
function App() {
  const [editorState, setEditorState] = React.useState("welcomeState");
  ...
  return (
    <>
      {["welcomeState", "registerState", "registrationSuccessState"].includes(
        editorState
      ) ? (
        <Login editorState={editorState} setEditorState={setEditorState} />
      ) : (
            ...
            {editorState === "startingState" ? (
              ...
              <div className="w-full">
                <div className="flex justify-end pr-28">
                  <button
                    onClick={() =>
                      handleProjectDeleteClick(currentProject["id"])
                    }
                  >
                    Delete
                  </button>
